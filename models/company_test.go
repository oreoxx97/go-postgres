...
var (
	companyDBTypes = map[string]string{`ID`: `uuid`, `Name`: `character varying`, `Address`: `text`, `PhoneNumber`: `character varying`, `Email`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_              = bytes.MinRead
)
