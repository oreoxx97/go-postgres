...
var (
	departmentDBTypes = map[string]string{`ID`: `uuid`, `Name`: `character varying`, `Description`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_                 = bytes.MinRead
)
