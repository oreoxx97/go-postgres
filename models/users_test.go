...
var (
	userDBTypes = map[string]string{`ID`: `uuid`, `Username`: `character varying`, `Password`: `character varying`, `Email`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
